...
const index = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Catalogue of New and Latest Silver Jewellery</title>
        <meta
          name="description"
          content="Presenting you our latest collection of Silver Jewellery with variety of weight and gemstones. Designing Jewel offers High Quality, Certified Hallmarked Premium Jewellery for you and your family."
        />
        <meta
          name="keywords"
